...
public class BoardController {
	...
	public String packboard(@RequestParam(value="name")String name,
	...
	public String selectboard(@RequestParam(value="param")String param,	
						Model model	     //有model，前端${ .....}才可以取值
			) {	
	...
	public String updateboard(@RequestParam(value="id")Integer id,
	...
	public String deleteboard(@RequestParam(value="id")Integer id,
							Model model
			) {
