            ...
            <div class="col-8 containerHeaderCard">
                <div class="h-100 containerHeaderFontCard">
                    <div class="containerHeaderFontDiv">
                       <span class="containerHeaderFontSpan">刪除商品</span>
                    </div>
                </div>
            </div>
            <div class="col-2"></div>
    ...
    <div class="container" style="margin-bottom:15px;">
        <div class="row">
            ...
            <div class="col-8 containerBodyCardOutside">
                <form:form action="exdeleteProduct" method="post" modelAttribute="productInfoBean" >
                
                
                    <div class="form-row containerBodyCard" >
                        <div class="col-md-4 containerBodyCardDiv">
                          <label class="containerBodyCardLabelFont" for="storename">商品名稱：</label>
