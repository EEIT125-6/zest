...
<%--                 	${stid} --%>
					...
					<div class = "form-row">
                    	...
                    	<div class = "col-md-12" style="text-align: center; margin-top: 5px" id="oneBt1">
                    		<button class="btn btn-success" >一鍵輸入 商品1 </button>
                    	</div>
                    	
                    	<script type="text/javascript">
                    		$("#oneBt1").click(function(){
                    	...
                    	<div class = "col-md-12" style="text-align: center; margin-top: 5px" id="oneBt2">
                    		<button class="btn btn-success" >一鍵輸入 商品2</button>
                    	</div>
                    	
                    	<script type="text/javascript">
                    		$("#oneBt2").click(function(){
                    	...
                    	<div class = "col-md-12" style="text-align: center; margin-top: 5px" id="oneBt3">
                    		<button class="btn btn-success" >一鍵輸入 商品3</button>
                    	</div>
                    	
                    	<script type="text/javascript">
                    		$("#oneBt3").click(function(){
